...
@section('titulo')
   Modificar Registro de Tipo de Movimiento
@endsection
...
{!! Form::model($tipomovimiento, ['route' => ['tipomovimiento.update', $tipomovimiento->id], 'method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}        
...
<?php session_start();
     ...
     <div class="uk-margin">
          ...
          {!! Form::text('operacion',null,['id'=>'operacion','class'=>'uk-input','placeholder'=>'Ingrese operacion Aplicable']) !!}        
       </div>
