...
<div class="uk-padding-small" uk-grid>
	<div class="uk-width-1-2  uk-padding-small" style="background-color:  #f0f0f0">
		{!! Form::open(['route' => 'tipomovimiento.store', 'method' => 'POST', 'class' => 'uk-form-stacked']) !!}     
			<?php
			session_start();
			...
			<fieldset class="uk-fieldset">
			      ...
			      <div class="uk-margin">
			          ...
			          {!! Form::text('operacion',null,['id'=>'operacion','class'=>'uk-input','placeholder'=>'Ingrese Tipo de Operacion']) !!}        
			       </div>
			      <div class="uk-margin">
			          {!! Form::label('Desde') !!}
