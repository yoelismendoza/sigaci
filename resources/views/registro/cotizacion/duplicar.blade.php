...
<div class="modal-wrapper" id="popup2">
 ...
 {!! Form::open(['route' => ['registro.cotizacion.duplicar',$cotizacions->id], 'method' => 'POST', 'class' => 'uk-grid-stacked','autocomplete'=>'off']) !!}
        ...
        <table class="uk-table uk-table-striped"> 
          ...
          <tr>
            <td colspan="4">
              {!!Form::submit('registro',['class'=>'uk-button uk-button-primary'])!!}
            </td>
          </tr>
        </tr>  
      </table>
