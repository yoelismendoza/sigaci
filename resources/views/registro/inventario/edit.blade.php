...
{!! Form::model($inventario, ['route' => ['inventario.update', $inventario->id], 'method' => 'PUT', 'enctype'=>'multipart/form-data']) !!}        
...
<?php session_start();
	  ...
	  $desde=date('Y-m-d');?>
               <div class="uk-margin">
                {!! Form::label('Almacen') !!}
                  {!! Form::select('id_almacen', $almacen,$inventario->id_almacen,['placeholder' => 'SELECCIONE','class' => 'uk-select', 'required']); !!}
             </div>
           <div class="uk-margin">
                {!! Form::label('Ejercicio') !!}
                  {!! Form::select('id_ejercicio', $ejercicio,$inventario->id_ejercicio,['placeholder' => 'SELECCIONE','class' => 'uk-select', 'required']); !!}
